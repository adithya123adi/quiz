...
export default class Mianquiz extends Component {
    ...
    viewclick = (data, index) => {
        console.log('wefdf', data['crct'])
    ...
    circleclick = (data, index) => {
        this.setState({ upperIndex: index, selected_option: '', color: false, view: 0 })

    }
    optionvalidation = (values, options, optionindex) => {
        console.log('asddfssd', options)
        let data = {
            'answer': options
        }
        var val = this.state.selected_quiz.concat(data)
        this.setState({ view: 1, selected_option: optionindex, selected_quiz: val })
        console.log('dsdfvds', this.state.selected_quiz)
    };
                            ...
                            return (
                                <View key={index}>
                                    ...
                                    <View style={{ alignItems: 'center', marginTop: '10%' }}>
                                        <Button buttonStyle={{ width: '35%' }} titleStyle={{ paddingRight: '17%' }} title='view' onPress={() => this.viewclick(data, index)}></Button>
                                    </View>
